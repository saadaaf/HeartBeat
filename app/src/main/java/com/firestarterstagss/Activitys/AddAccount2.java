...
public class AddAccount2 extends AppCompatActivity {
...
//    String deviceIMEI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        new HideActionBar(AddAccount2.this);
        ...
        tick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cookies.contains("ds_user_id")) {
                    ...
                    Toast.makeText(AddAccount2.this, "Please login and wait until page loading finishes", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onPageFinished(WebView view, String url) {
             ...
             //   Toast.makeText(AddAccount.this, cookies + "", Toast.LENGTH_SHORT).show();
                if (cookies.contains("ds_user_id")) {
                    ...
                    TourGuide.init(AddAccount2.this).with(TourGuide.Technique.CLICK)
...
//        insertDummyContactWrapper();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        new MyIntent(AddAccount2.this, HomeActivity.class);
    }
...
//                } else {
//                    // Permission Denied
//                    Toast.makeText(AddAccount2.this,  "Permission Denied", Toast.LENGTH_SHORT)
//                            .show();
//                }
//                break;
//            default:
    ...
    public void CallLogin(final String cookie) {
        StringRequest strReq = new StringRequest(Request.Method.GET, HeartBeatConfig.LoginURL, new Response.Listener<String>() {
                                ...
                                try {
                                    ...
                                    if(jsonObject2.has("viewer") && jsonObject2.get("viewer")!=null && !jsonObject2.get("viewer").toString().equalsIgnoreCase("null") )
                                    {
                                      ...
                                      //  Toast.makeText(AddAccount.this, "::"+username, Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(AddAccount2.this,"There was some problem with your request,login again",Toast.LENGTH_LONG).show();
                                    }
            ...
            public void onErrorResponse(VolleyError error) {
                new HeartBeatConfig().errorHanling(AddAccount2.this, error);
            }
        }){
            @Override
        ...
        Volley.newRequestQueue(AddAccount2.this).add(strReq);
...
//            heartBeatSession.getHeartBeatUsersDao().insertOrReplace(u);
        if(new SharedPref().getSP(AddAccount2.this).contains("username")){
            new SharedPref().clearSPData(AddAccount2.this);
        }

        new SharedPref().AddSPData(AddAccount2.this,"id", userProfile.getPk()+"");
        new SharedPref().AddSPData(AddAccount2.this,"username", userProfile.getUsername());
        new SharedPref().AddSPData(AddAccount2.this,"cookie", userProfile.getCookie());
        new SharedPref().AddSPData(AddAccount2.this,"csrf", userProfile.getCsrf());
        new SharedPref().AddSPData(AddAccount2.this,"profilepic", userProfile.getProfilePicUrl());
        new SharedPref().AddSPData(AddAccount2.this,"edge_array",  userProfile.getEdge_array());
        new SharedPref().AddSPData(AddAccount2.this,"IMEI", device);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (satus.equals("200")){
                       ...
                       boolean b= new ProductController(AddAccount2.this).addUsre(um);

                       if (b){
                           Toast.makeText(AddAccount2.this, "Account Added", Toast.LENGTH_LONG).show();
                           new SharedPref().AddSPData(AddAccount2.this,"user_id", jsonObject.getString("id"));
                           Intent intent = new Intent(AddAccount2.this, HomeActivity.class);
                           startActivity(intent);
                           finish();
                       }else {
                           Toast.makeText(AddAccount2.this, "Account Already Added", Toast.LENGTH_LONG).show();
                           Intent intent = new Intent(AddAccount2.this, HomeActivity.class);
                           startActivity(intent);
                           finish();
